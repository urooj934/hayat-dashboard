 ...
 //})
    ...
    <Section>
        ...
        <TableContainer component={Paper}>
            <Table sx={{border:3}} >
                <TableHead >
                  <TableRow><TableCell sx={{backgroundColor:'purple',color:'white',fontSize:'1.3rem',fontWeight:'bold'}}align="center" colSpan={12}>Requested Food Delivery</TableCell></TableRow>
                    <TableRow>
...
background-image: linear-gradient(-315deg, #21d190 0%, blueviolet 74%);
  ...
  `;
export default ReqFoodDelivery;
