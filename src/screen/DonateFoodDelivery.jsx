    ...
    <Section>
        ...
        <TableContainer component={Paper}>
            <Table sx={{border:3}} >
                <TableHead >
                  <TableRow>
                  <TableCell sx={{backgroundColor:'purple',color:'white',fontSize:'1.3rem',fontWeight:'bold'}}align="center" colSpan={12}>Donated Food Delivery</TableCell>
                  </TableRow>
                    <TableRow>
                ...
                <TableBody>
                    ...
                    <TableCell sx={{flexDirection:"row"}}>
                      <Button onClick={()=>{handledelete(row.ID)}} sx={{ color:'green'}}><DeleteIcon/></Button>
                      <Button onClick={()=>{handleverify(row.ID,row.uid,row.title)}} sx={{ color:'green'}}><CheckCircleIcon/></Button></TableCell> 
                        </TableRow>
...
float:right;
  ...
  `;
export default DonateFoodDelivery;
